    ...
    <main className="text-[#808080]">
      ...
      <section className="px-[18px] lg:px-[244px] gap-[75px]">
        ...
        <section className="w-full">
          ...
          <h3 className="text-[16px] font-semibold text-[#181818] mt-[32px]">
          ...
          <p className="text-[15px] mt-[9px]">
            ...
            Express, and MongoDB, enabling me to create dynamic and scalable web
            applications. With a commitment to delivering clean, efficient code
            and a knack for problem-solving, I strive to leverage my skills to
            craft engaging digital experiences that make a meaningful impact.
          </p>
      ...
      <div className="flex items-center w-full mt-[100px] mb-24 px-[16px] lg:px-[244px]">
        <button
